...
\LaTeX/Beamer-Paketes erstellt werden.
...
automatisiert eine PDF-""Pr"a"-sen"-ta"-tion erstellt werden.
...
Mit \verb!HSMW-Poster! k"onnen wissenschaftliche Poster im Querformat erstellt
werden.
...
%\TeX{} e.V., URL: \url{http://www.dante.de}.
...
\bibitem{cdmanual} \textsc{Hochschule Mittweida, AG Internet:} \emph{Das neue
  CD}, URL: \url{http://www.agi.hs-mittweida.de}.

\bibitem{Kohler:2010} \textsc{E. Kohler:} \emph{otftotfm Manual}, LCDF Type
Software, URL: \url{http://www.lcdf.org/type}.
